...
exit 1
 ...
 if [[ -e ~/.ngrok2/ngrok.yml ]] || [[ -e ~/.config/ngrok/ngrok.yml ]]; then
...
if [[ $mode_choice -eq 2 ]]; then
    ...
    printf "\e[1;77m    Usage: ./camphish_auto.sh --tunnel ngrok --template meeting --ngrok-token YOUR_TOKEN\e[0m\n"
